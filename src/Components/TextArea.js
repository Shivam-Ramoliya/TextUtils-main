...
export default function TextArea(props) {
    ...
    const handleReverse = () => {
        if (!originalText.trim()) {
            props.showAlert("Nothing to reverse!", "warning");
            return;
        }
        let newtext = "";
    ...
    const handleVowelConsonant = () => {
        if (!originalText.trim()) {
            props.showAlert("Nothing to count!", "warning");
            return;
        }
    ...
    const handleBase64Encode = () => {
        if (!originalText.trim()) {
            props.showAlert("Nothing to encode!", "warning");
            return;
        }
    ...
    const handleBase64Decode = () => {
        if (!originalText.trim()) {
            props.showAlert("Nothing to decode!", "warning");
            return;
        }
        try {
    ...
    const handleDecimalToRoman = () => {
        ...
        if (!originalText.trim()) {
            props.showAlert("Please enter a value to convert.", "warning");
            return;
        }
    ...
    const handleDecimalToBinary = () => {
        ...
        if (!originalText.trim()) {
            props.showAlert("Please enter a number to convert.", "warning");
            return;
        }
    ...
    const handleDecimalToHex = () => {
        ...
        if (!originalText.trim()) {
            props.showAlert("Please enter a decimal number.", "warning");
            return;
        }
                    ...
                    <div className="mb-3 position-relative">
                        <label htmlFor="originalTextArea" className="form-label d-flex justify-content-between align-items-center">
                            ...
                            <div className="d-flex gap-2 m-2">
                                ...
                                <button type="button" className="btn btn-sm btn-outline-info" onClick={handleSpeak}>
                                    🔊
                                </button>
                            </div>
                        </label>
            ...
            <div className="mb-4 d-flex flex-column flex-wrap gap-4">
                ...
                <div>
                    ...
                    <div className="d-flex flex-wrap gap-2">
                        <button className="btn btn-info" onClick={handleUPClick}>UPPERCASE</button>
                        <button className="btn btn-info" onClick={handleLOWClick}>lowercase</button>
                        <button className="btn btn-info" onClick={handleSentenceCase}>Sentence case</button>
                        <button className="btn btn-info" onClick={handleCapitalizedCase}>Capitalized Case</button>
                        <button className="btn btn-info" onClick={handleAlternatingCase}>aLtErNaTiNg cAsE</button>
                        <button className="btn btn-info" onClick={handleInverseCase}>InVeRsE CaSe</button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="d-flex flex-wrap gap-2">
                        <button className="btn btn-info" onClick={handleSpaces}>Remove Extra Spaces</button>
                        <button className="btn btn-info" onClick={handleRemoveAllSpaces}>Remove All Spaces</button>
                        <button className="btn btn-info" onClick={handleRemoveNumbers}>Remove Numbers</button>
                        <button className="btn btn-info" onClick={handleRemovePunctuation}>Remove Punctuation</button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="d-flex flex-wrap gap-2">
                        <button className="btn btn-info" onClick={handleReverse}>Reverse</button>
                        <button className="btn btn-info" onClick={handleVowelConsonant}>Vowel/Consonant</button>
                        <button className="btn btn-info" onClick={handleCharFrequency}>Character Frequency</button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="d-flex flex-wrap gap-2">
                        <button className="btn btn-info" onClick={handleBase64Encode}>Base64 Encode</button>
                        <button className="btn btn-info" onClick={handleBase64Decode}>Base64 Decode</button>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="d-flex flex-wrap gap-2">
                        <button className="btn btn-info" onClick={handleDecimalToRoman}>Decimal to Roman</button>
                        <button className="btn btn-info" onClick={handleRomanToDecimal}>Roman to Decimal</button>
                        <button className="btn btn-info" onClick={handleDecimalToBinary}>Decimal to Binary</button>
                        <button className="btn btn-info" onClick={handleBinaryToDecimal}>Binary to Decimal</button>
                        <button className="btn btn-info" onClick={handleDecimalToHex}>Decimal to Hex</button>
                        <button className="btn btn-info" onClick={handleHexToBinary}>Hex to Binary</button>
                    </div>
                </div>
            </div>
        </div>
